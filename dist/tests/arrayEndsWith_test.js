...
var resultTrue1 = index_1.arrayEndsWith(endsWith1, arr);
var resultTrue2 = index_1.arrayEndsWith(endsWith2, arr);
if (resultTrue1 && resultTrue2)
    console.log('test 1 passed');
else
    console.log('test 1 FAILED');
// Test 2: function should return false if array doesn't end with passed argument:
resultTrue1 = index_1.arrayEndsWith(doesntEndWith1, arr);
resultTrue2 = index_1.arrayEndsWith(doesntEndWith2, arr);
if (!resultTrue1 && !resultTrue2)
...
try {
    var result = index_1.arrayEndsWith('', arr);
}
catch (e) {
    triggeredError = true;
}
...
try {
    var result = index_1.arrayEndsWith([1], '');
}
catch (e) {
    triggeredError = true;
}
...
triggeredError = false;
try {
    var result = index_1.arrayEndsWith([2, 3, 4], arr);
}
catch (e) {
    triggeredError = true;
}
