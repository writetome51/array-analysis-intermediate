...
var resultTrue1 = index_1.arrayStartsWith(StartsWith1, arr);
var resultTrue2 = index_1.arrayStartsWith(StartsWith2, arr);
if (resultTrue1 && resultTrue2)
    console.log('test 1 passed');
else
    console.log('test 1 FAILED');
// Test 2: function should return false if array doesn't end with passed argument:
resultTrue1 = index_1.arrayStartsWith(doesntStartWith1, arr);
resultTrue2 = index_1.arrayStartsWith(doesntStartWith2, arr);
if (!resultTrue1 && !resultTrue2)
...
// Test 2A
arr = [];
if (index_1.arrayStartsWith([], arr))
...
try {
    var result = index_1.arrayStartsWith('', arr);
}
catch (e) {
    triggeredError = true;
}
...
try {
    var result = index_1.arrayStartsWith([1], '');
}
catch (e) {
    triggeredError = true;
}
...
triggeredError = false;
try {
    var result = index_1.arrayStartsWith([2, 3, 4], arr);
}
catch (e) {
    triggeredError = true;
}
